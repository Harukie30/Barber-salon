  ...
  return (
    <section id="visit" className="scroll-mt-20 bg-secondary/40 py-20 sm:py-28">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 grid gap-12 lg:grid-cols-[minmax(0,0.95fr)_minmax(0,1.05fr)] lg:gap-14 xl:gap-16">
          <Reveal className="space-y-10 lg:space-y-12">
            <div>
          ...
          <Reveal className="flex min-h-[360px] flex-col lg:min-h-full">
